...
class Menu_Card_Admin_Base {
   ...
   * @since     0.1.0
   */
  protected function Menu_Card_Admin_Base() {
  ...
  public function render_input_field( $args ) {
    ...
    echo "<input class='regular-text' type='$field_type' name='menu-card-settings[$field_name]' value='$field' />";
  ...
  public function render_select_field($args) {
    ...
    echo "<select name='menu-card-settings[$field_name]'>";
  ...
  public function render_radio_field($args) {
    ...
    foreach($options as $value => $label) {
      echo "<label>";
      echo "<input type='radio'" . checked( $field, $value, false ) . "name='menu-card-settings[$field_name]' value='$value'/>";
      echo " $label</label><br>";
    }
  ...
  public function render_checkbox_field($args) {
    ...
    foreach($options as $value => $label) {
      ...
      echo "<input type='checkbox'"
              ...
              . "name='menu-card-settings[$field_name][$value]' value='on'/>";
      echo " $label</label><br>";
    }
