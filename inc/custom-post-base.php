<?php
/**
 * Defines Menu_Card_Custom_Post_Base class.
 *
 * @package Menu_Card
...
class Menu_Card_Custom_Post_Base {
    ...
    protected static $styles = array('menu-card-custom-post-base');
    protected static $scripts = array();

    public function Menu_Card_Custom_Post_Base() {
    ...
    protected function add_meta_box($id, $title, $func_name) {
        $markup_id = Menu_Card_Info::slug. "-" . $id;
    ...
    public function handle_postbox_classes($classes){
        ...
        array_push($classes, Menu_Card_Info::slug . '-metabox');
        return $classes;
    }
    ...
    protected function register_script_and_style_base() {
        ...
        wp_register_style( self::$styles[0],
            Menu_Card_Info::$plugin_url . '/assets/css/admin-custom-post-base.css',
            array( ),
